...
.machinecard > div > .progressbar > div {
  position: absolute;
  left: 0px;
  top: 0px;
  height: 100%;
...
.flag.error {
  ...
  background-image: url("~@/assets/icons/icon-alertoctagon_128x128.png");
